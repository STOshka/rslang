...
export const wordsData: Array<IWordsData> = [];
...
`);
export const wordBtnsHTML = (`
            <div class="word-btns">
                ${soundLogoSvg}
                <button class="word-btn" id="word-btn1"></button>
                <button class="word-btn" id="word-btn2"></button>
                <button class="word-btn" id="word-btn3"></button>
                <button class="word-btn" id="word-btn4"></button>
            </div>
`)
...
export const wordsPageHTML = (`
    ...
    <nav class="header-nav">
        <ul class="header-nav-list">
            ...
            <li class="header-nav-item"><a href="#wordlist" class="header-nav-link active-nav">Book</a></li>
    ...
    <div class="words-partitions-btns-container">
        <button class="words-partition-btn" id="group0" data-group="0">Partitions 1</button>
        <button class="words-partition-btn" id="group1" data-group="1">Partitions 2</button>
        <button class="words-partition-btn" id="group2" data-group="2">Partitions 3</button>
        <button class="words-partition-btn" id="group3" data-group="3">Partitions 4</button>
        <button class="words-partition-btn" id="group4" data-group="4">Partitions 5</button>
        <button class="words-partition-btn" id="group5" data-group="5">Partitions 6</button>
    </div>
    </header>
    ...
    <div class="words-pagination">
        ...
        <h3 class="page-number-title">Page</h3>
        <div class="input-container">
            <input class="input-page-number" type="text">
            <input class="submit-page-number" placeholder="GO" readonly="readonly">
        </div>
        <h3 class="page-number-title">from 30</h3>
